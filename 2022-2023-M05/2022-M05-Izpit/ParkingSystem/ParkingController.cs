...
public class ParkingController
{
    ...
    public string CreateParkingSpot(List<string> args)
    {
        ...
        if (type == "car")
        {
            CarParkingSpot spot = new CarParkingSpot(id, occupied, price);
            parkingSpaces.Add(spot);
        }
        else if (type == "bus")
        {
            BusParkingSpot spot = new BusParkingSpot(id, occupied, price);
            parkingSpaces.Add(spot);
        }
        else if (type == "subscription")
        {
            ...
            SubscriptionParkingSpot spot = new SubscriptionParkingSpot(id, occupied, price, registarationPlate);
            parkingSpaces.Add(spot);
        }
    ...
    public string ParkVehicle(List<string> args)
    {
        ...
        if (Equals(spot, default(ParkingSpot)))
