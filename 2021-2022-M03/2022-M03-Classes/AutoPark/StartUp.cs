...
namespace AutoPark
{
    ...
    {
        public static Dictionary<string, Car> cars = new Dictionary<string, Car>(); // model Car
        public static Dictionary<string, Part> parts = new Dictionary<string, Part>(); // name Part
